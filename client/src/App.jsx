...
import ProjectDocumentation from "./components/ProjectDocumentation.jsx";
...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/experience/sparkle-qa"
        element={<ProjectDetail title="Sparkle QA Log" />}
      />
      <Route
        path="/experience/ipaskil"
        element={<ProjectDetail title="iPaskil Archive" />}
      />
      <Route
        path="/experience/qa-automation"
        element={<ProjectDetail title="Automation Data" />}
      />
      <Route
        path="/experience/ux-analysis"
        element={<ProjectDetail title="UX Research" />}
      />
      <Route path="/projects/espyreal" element={<ProjectDocumentation id="espyreal" />} />
      <Route path="/projects/ipaskil" element={<ProjectDocumentation id="ipaskil" />} />
    </Routes>
  );
}

...
const TimelineItem = ({ exp, progress, index, total }) => {
  ...
  return (
    <div
      className={`group flex w-full items-center justify-between ${exp.side === "right" ? "md:flex-row-reverse" : "md:flex-row"} flex-col md:flex-row gap-12 md:gap-0`}
    >

...
const HeroCard = () => {
  ...
  return (
    <div className="perspective-1000 w-full max-w-[450px] aspect-[1.4/1]">
      <div
        ref={cardRef}
      ...
      >
        ...
        <div className="h-[35%] bg-[#FF3333] border-b-[6px] border-black flex flex-col items-center justify-center relative">
          <div className="absolute inset-0 opacity-10 [background-size:20px_20px] [background-image:linear-gradient(rgba(0,0,0,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.1)_1px,transparent_1px)]" />
          
          {/* Glitch Overlay (on hover) */}
          <div className="absolute inset-0 bg-[#FF00FF] opacity-0 group-hover:opacity-40 translate-x-[3px] translate-y-[3px] transition-opacity -z-10" />
        ...
        <div className="h-[65%] bg-[#f4f1ea] relative flex items-center justify-center overflow-hidden">
          ...
          <div className="relative w-[100%] md:w-[96%] h-auto z-20 px-4">
            <img 
              src={GraffitiName} 
